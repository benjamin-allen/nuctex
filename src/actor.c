...
A_index AIndex = { 
	...
	.actor[2] = {.id=2, .name="Sean", .health=200, .strength=12, .agility=9, .intelligence=11, .charisma=8, .isNPC=1, .talkText="Heya. Name's Sean. You have a reason to be here?", .actorPos=&LIndex.loc[1], .inv.item[0]=&IIndex.item[0], .inv.item[1]=&IIndex.item[0],}
};
